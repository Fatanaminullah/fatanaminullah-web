...
export function About() {
  return (
    <section id="about" data-screen-label="02 About" className={styles.about}>
      <div className={styles.grid}>
        <div>
          ...
          <div className={styles.copy}>
            ...
            <p className={styles.copySecondary}>
              I bridge engineering precision with visual craft — the kind of
              work that feels inevitable once it ships.
            </p>
          </div>
          ...
          <div className={`${styles.signature} reveal-fade`} data-delay="0.2">
            <span className={styles.sig}>— Fatan</span>
        ...
        <div className={styles.right}>
          <div className={styles.bento}>
            ...
            >
              <div className={styles.k}>
                &ldquo;The restraint <em className={styles.quoteEm}>is</em> the
                craft.&rdquo;
              </div>
